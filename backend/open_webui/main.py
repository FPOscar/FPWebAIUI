...
app.state.config.AZURE_MISTRAL_OCR_ENDPOINT = AZURE_MISTRAL_OCR_ENDPOINT
app.state.config.AZURE_MISTRAL_OCR_MODEL = AZURE_MISTRAL_OCR_MODEL
app.state.config.AZURE_MISTRAL_OCR_INCLUDE_IMAGE_BASE64 = (
    AZURE_MISTRAL_OCR_INCLUDE_IMAGE_BASE64
)
