...
async def update_rag_config(request: Request, form_data: ConfigForm, user=Depends(get_admin_user)):
    ...
    return {
        ...
        'MINERU_API_TIMEOUT': config.MINERU_API_TIMEOUT,
        'MINERU_PARAMS': config.MINERU_PARAMS,
        'AZURE_MISTRAL_OCR_API_KEY': getattr(config, 'AZURE_MISTRAL_OCR_API_KEY', ''),
        'AZURE_MISTRAL_OCR_ENDPOINT': getattr(config, 'AZURE_MISTRAL_OCR_ENDPOINT', ''),
        'AZURE_MISTRAL_OCR_MODEL': getattr(config, 'AZURE_MISTRAL_OCR_MODEL', ''),
        'AZURE_MISTRAL_OCR_INCLUDE_IMAGE_BASE64': getattr(
            config, 'AZURE_MISTRAL_OCR_INCLUDE_IMAGE_BASE64', False
        ),
        # Reranking settings
        'RAG_RERANKING_MODEL': config.RAG_RERANKING_MODEL,
        'RAG_RERANKING_ENGINE': config.RAG_RERANKING_ENGINE,
