...
<div
	...
	class="h-screen max-h-[100dvh] min-h-screen select-none {$showSidebar
		...
		? `ml-[4.5rem] md:ml-0 `
		: 'transition-width duration-200 ease-in-out'}  shrink-0 bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-200 text-sm fixed z-50 top-0 left-0 overflow-x-hidden findlay-park-sidebar
        "
